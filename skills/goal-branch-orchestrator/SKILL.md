...
- every research-worker status records search queries when search was used, source URLs, tool families used, local files read, and exact local/shell inspection commands, and remained read-only;
