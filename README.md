...
- `goal-plan-amender` creates file-backed adaptation packets with selected amender model ladders and telemetry, validates amendment proposals against the live manifest and terminal/active branch immutability rules, applies accepted changes only to unstarted future work, archives prior manifests, regenerates changed future branch prompts through preflight helpers, and reruns bundle lint.
...
```bash
npx github:jc1122/codex-goal-orchestration-skills#v0.2.4
```
